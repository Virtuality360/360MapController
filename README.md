...
pannellum-react has a peer dependency with react ^16 || ^17 || ^18
npm is looking for 16.x
other packages need react 17+
...
Builds to the dist directory, with the app in the directory named after the build target.
